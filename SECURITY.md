...
If you find a security vulnerability in traincheck, please report it through [GitHub's private vulnerability reporting](https://github.com/darkleia/traincheck/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact victoria.besedina@gmail.com for details.
